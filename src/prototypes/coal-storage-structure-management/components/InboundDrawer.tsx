 ...
 * 操作 · 入库
 *
 * 在所选分区的顶层新增煤层。圆形煤场堆料机绕中心连续回转，会在所选扇区上铺同一层煤，
 * 因此总煤量在所选分区间平均分摊，各分区新增煤层的体积与俯仰夹角由几何关系自动反算。
  ...
  return (
    ...
    >
      <div className="cssm-form-note">
        入库将在所选分区的<b>煤堆顶层</b>新增一层煤。总煤量在所选分区间平均分摊（堆料机绕中心
        回转在所选扇区上铺同一层煤），各分区新增煤层的体积按所填计算密度折算，起始与结束俯仰夹角
        由扇形楔几何关系反算。留空入厂登记编号时，新增煤层将标记为待人工确认。
      </div>
