...
const MOCK_TASKS = [
  {
    ...
    status: '未执行',
    children: [
      { id: 'T-002-1', seq: 1, type: '车辆调度', target: '2#汽采集样', action: '-', emptyCount: '-', duration: '3 min ', distance: ' 200 m' },
      { id: 'T-002-2', seq: 2, type: '样桶装卸', target: '2#汽采集样', action: '31卸空桶装满桶', emptyCount: '6' }
    ]
  },
  {
    id: 'T-20231024-001',
  ...
  },
  {
    ...
    children: [
      { id: 'T-005-1', seq: 1, type: '车辆调度', target: '归批制样', action: '-', emptyCount: '-', duration: '5 min', distance: ' 400 m' },
      { id: 'T-005-2', seq: 2, type: '样桶装卸', target: '归批制样', action: '31卸空桶装满桶', emptyCount: '4' }
    ]
  },
  {
    id: 'T-20231024-003',
  ...
  },
  {
    ...
    taskType: '调度任务',
    children: [
      { id: 'T-006-1', seq: 1, type: '车辆调度', target: '1#汽车集样', action: '-', emptyCount: '-', duration: '5 min', distance: '500 m' },
      { id: 'T-006-2', seq: 2, type: '样桶装卸', target: '1#汽车集样', action: '31卸空桶装满桶', emptyCount: '2' }
    ]
  },
  {
    id: 'T-20231024-004',
    ...
    status: '已完成',
    children: [
      { id: 'T-004-1', seq: 1, type: '车辆调度', target: '卸样端', action: '-', emptyCount: '-', duration: '20', distance: '1.5km' },
      { id: 'T-004-2', seq: 2, type: '样桶装卸', target: '卸样端', action: '12卸满桶', emptyCount: '-' }
    ]
  }
];
            ...
            <table className="w-max min-w-full text-left border-collapse text-sm">
              <thead className="bg-[#0f172a]/90 text-gray-400 sticky top-0 z-20 shadow-md">
                <tr>
                  ...
                  <th className="py-3 px-4 font-medium sticky left-10 bg-[#0f172a] z-30">任务编号 / 序号</th>
                  <th className="py-3 px-4 font-medium">触发方式 / 任务类型</th>
                  <th className="py-3 px-4 font-medium">作业小车 / 装卸端</th>
                  <th className="py-3 px-4 font-medium">计划时间 / 操作类型</th>
                  <th className="py-3 px-4 font-medium">开始时间 / 空桶数</th>
                  <th className="py-3 px-4 font-medium">结束时间</th>
                  <th className="py-3 px-4 font-medium">预计耗时 min / 行驶距离</th>
                ...
                {MOCK_TASKS.map(task => (
                  <React.Fragment key={task.id}>
                    <tr className="hover:bg-cyan-900/20 transition-colors group bg-[#1e293b]/20">
                      ...
                      <td className="py-3 px-4 font-mono text-cyan-300 font-medium sticky left-10 bg-[#1e293b] group-hover:bg-cyan-900/40 z-20 whitespace-nowrap">{task.id}</td>
                    ...
                    {expandedKeys.has(task.id) && task.children.map(child => (
                      <tr key={child.id} className="hover:bg-cyan-900/10 transition-colors bg-[#0b1120]/40">
                        ...
                        <td className="py-2.5 px-4 pl-12 border-l-2 border-cyan-900/30 text-gray-400 relative sticky left-10 bg-[#0b1120] group-hover:bg-cyan-900/20 z-20 whitespace-nowrap">
                          <span className="absolute left-0 top-1/2 w-8 border-t-2 border-cyan-900/30 -mt-[1px]"></span>
                          [序号 {child.seq}]
                        </td>
                        <td className="py-2.5 px-4 text-gray-300 whitespace-nowrap">{child.type}</td>
                        <td className="py-2.5 px-4 text-cyan-300 whitespace-nowrap">{child.target}</td>
                        <td className="py-2.5 px-4 text-gray-300 whitespace-nowrap">{child.action}</td>
                        <td className="py-2.5 px-4 text-gray-300 whitespace-nowrap">{child.emptyCount}</td>
                        ...
                        <td className="py-2.5 px-4 sticky right-24 bg-[#0b1120] group-hover:bg-cyan-900/20 z-20"></td>
